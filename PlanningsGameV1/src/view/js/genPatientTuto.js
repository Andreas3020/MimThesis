...
var patientListTuto = [
  ...
  new Klant({patientID: 3, firstName: "Eric", lastName: "Demeulemeester", availability: ["Monday","Tuesday","Saturday"], onco: 0, chemo: 5, lastPatientBool: false, chemoLength: 3, probBloodFail: 0, weekNrFirstSelectedSlot: -1, lastSelectedSlotId: 0}),
